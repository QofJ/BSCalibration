...
int Calibration(BSTimeoffCalibration* BS, double rin, double rout, double El, TH2D* h2, double dCx = 0, double dCy = 0)
{
...
int main(int argc, char* argv[])
{
	...
	TH2D* h2_out = new TH2D("h2", "Ra & Dec Map", 3600., 0., 360., 1800., -90., 90.);
	...
	for (i = 0; i < ITER; i++)
	{
		...
		Calibration(bscal, rin, rout, El, h2_out, dCenterx, dCentery);
		...
		nt_out->Write(0, TObject::kOverwrite);
